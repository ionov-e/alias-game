...
type SendAnimation struct {
	...
	Animation             interface{}      `json:"animation"`                          // Required: Animation to send as file_id, HTTP URL, or upload
	Duration              *int             `json:"duration,omitempty"`                 // Optional: Duration of the animation in seconds
	Width                 *int             `json:"width,omitempty"`                    // Optional: Animation width
	Height                *int             `json:"height,omitempty"`                   // Optional: Animation height
	Thumbnail             interface{}      `json:"thumbnail,omitempty"`                // Optional: Thumbnail for the animation in JPEG format
	Caption               *string          `json:"caption,omitempty"`                  // Optional: Caption for the animation, up to 1024 characters
	...
	HasSpoiler            *bool            `json:"has_spoiler,omitempty"`              // Optional: Display the animation with a spoiler animation
